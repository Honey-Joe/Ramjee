      ...
      <div className="py-[20px] lg:py-[40px] w-full grid grid-cols-1 gap-4">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex gap-3 items-center flex-wrap">
            <div className="">
            <img src={profile_img} alt="profile image" className="w-[50px] h-[50px] " />

            </div>
            <div>
                <p className="font-[Pro] text-[#7f7e97] ">By <span className="text-black">David Millar</span></p>
            </div>
            <div>
                <Dot size={30}></Dot>
            </div>
            <div className="flex items-center gap-2">
                ...
                <div>
                    <p className="font-[Pro] text-[#7f7e97] font-medium">24/07/2024</p>
                </div>
            </div>
            <div>
                <Dot size={30}></Dot>
            ...
            <div className="flex items-center gap-2">
                ...
                <div>
                    <p className="font-[Pro] text-[#7f7e97] font-medium">2,260 Students</p>
                </div>
            </div>
          </div>
        </div>
